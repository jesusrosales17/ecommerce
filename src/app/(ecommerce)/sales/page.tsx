...
const SalesProducsPage = async ({ searchParams }: { searchParams: { [key: string]: string | undefined } }) => {
    ...
    return (
      <main className="container mx-auto lg:px-3 py-3 grid grid-cols-1 md:grid-cols-[20%_77%] mt-5 gap-4">
        ...
        <div className="flex flex-col items-center justify-center min-h-[300px] bg-white p-6">
          <h2 className="text-2xl font-bold mb-2">No hay productos en oferta</h2>
          <p className="text-gray-500 text-center">No se encontraron productos en oferta con los filtros seleccionados</p>

...
export default function ReportsPage() {
  ...
  const handleExport = async (format: 'pdf' | 'excel' | 'csv') => {
    ...
    try {
      ...
      a.style.display = 'none';
      a.href = url;
      a.download = `reporte-general-${selectedDateRange}-${new Date().toISOString().split('T')[0]}.${format}`;
      document.body.appendChild(a);
      a.click();
      window.URL.revokeObjectURL(url);
      document.body.removeChild(a);
    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-semibold mb-2">Error al cargar reportes</h2>
          <p className="text-muted-foreground mb-4">
            No se pudieron cargar los datos de reportes. Por favor, inténtalo de nuevo.
          </p>
          <button 
            onClick={() => refetch()}
